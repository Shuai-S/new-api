...
const (
	...
	ChannelTypeCodex          = 57
	ChannelTypeOpenAIChatOnly = 58
	ChannelTypeOpenAIResponsesOnly = 59
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeOpenAIChatOnly: "OpenAIChatOnly",
	ChannelTypeOpenAIResponsesOnly: "OpenAIResponsesOnly",
}
...
func IsOpenAIChatCompletionsOnlyChannelType(channelType int) bool {
	return channelType == ChannelTypeOpenAIChatOnly
}

func IsOpenAIResponsesOnlyChannelType(channelType int) bool {
	return channelType == ChannelTypeOpenAIResponsesOnly
}
