...
const defaultGlobalSettingInputs = {
  ...
  'global.channel_endpoint_filter_enabled': false,
        ...
        >
          <Form.Section text={t('全局设置')}>
            <Row>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  label={t('启用渠道 Endpoint 过滤')}
                  field={'global.channel_endpoint_filter_enabled'}
                  onChange={(value) =>
                    setInputs({
                      ...inputs,
                      'global.channel_endpoint_filter_enabled': value,
                    })
                  }
                  extraText={t(
                    '开启后，渠道 settings.allowed_endpoint_types 将参与分发过滤；关闭后忽略所有渠道端点过滤配置。',
                  )}
                />
              </Col>
            </Row>
