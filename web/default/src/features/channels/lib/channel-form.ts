...
export const channelFormSchema = z
  .object({
    ...
    upstream_stream_for_non_stream: z.boolean().optional(),
...
export const CHANNEL_FORM_DEFAULT_VALUES: ChannelFormValues = {
  ...
  upstream_stream_for_non_stream: false,
  system_prompt: '',
    ...
    try {
      ...
      extraSettings = {
        ...
        upstream_stream_for_non_stream:
          parsed.upstream_stream_for_non_stream || false,
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    upstream_stream_for_non_stream:
      formData.upstream_stream_for_non_stream || false,
